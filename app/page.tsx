          ...
          <div className="flex gap-[1vw] h-[45%] items-stretch justify-stretch content-stretch">
            ...
            >
              ...
              <div className=" absolute flex flex-col justify-between top-0 left-0 h-full w-full p-[1vw] hover:p-[1.5vw] transition-all duration-500">
                ...
                {/* <div className="h-full relative min-w-[40%] w-full rounded-[2vw] overflow-hidden" style={{ backgroundImage: 'url(https://img.freepik.com/premium-photo/young-telemarketer-woman-isolated-white-wall-pointing-with-index-finger-great-idea_1368-67113.jpg?w=1060)', backgroundSize: 'cover', backgroundPosition: 'center' }}></div> */}
                <div></div>
              </div>
            </Link>
